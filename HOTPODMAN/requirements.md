...
2. **Withdrawal Web** สำหรับค้นหา สแกน และเบิกสินค้าออกจากคลัง

ผู้ใช้งานเข้าถึงระบบผ่าน Web Browser โดยหน้าจอต้องรองรับคอมพิวเตอร์ โน้ตบุ๊ก แท็บเล็ต และโทรศัพท์มือถือ ส่วนงานรับเข้าและพิมพ์ Label ให้ใช้งานบนคอมพิวเตอร์คลังที่เชื่อมต่อโปรแกรม Print Control และเครื่องพิมพ์ Label
...
8. เบิกสินค้าออกจากคลังผ่าน Withdrawal Web ตามสิทธิ์และวัตถุประสงค์
...
- Withdrawal Web สำหรับเบิกสินค้าออกจากคลัง
- Responsive Web สำหรับคอมพิวเตอร์ โน้ตบุ๊ก แท็บเล็ต และโทรศัพท์มือถือ
...
- การตรวจนับสต็อกผ่าน Web Browser บนอุปกรณ์พกพา
...
- ตรวจนับสต็อกผ่าน Web Browser บนอุปกรณ์พกพา
...
flowchart TD
    ...
    G --> H[ตรวจนับผ่าน Web บนอุปกรณ์พกพา]
    H --> I[เบิกวัตถุดิบผ่าน Withdrawal Web]
...
- ใช้งานผ่าน Web Browser บนโทรศัพท์มือถือ แท็บเล็ต หรือคอมพิวเตอร์
...
```mermaid
flowchart LR
    U[Mobile / Tablet / Notebook / Computer] --> B[Web Browser]
    B --> N[Next.js Web Application]
    N --> A[Backend REST API]
    A --> D[(PostgreSQL)]
    A --> E[ระบบจัดซื้อ / บัญชี / ERP]
    N --> P[Print Control บนคอมพิวเตอร์คลัง]
    P --> L[Label Printer]
```
...
| Client Access | Web Browser บนมือถือ แท็บเล็ต โน้ตบุ๊ก และคอมพิวเตอร์ |
...
2. ผู้ใช้งานต้องตรวจนับผ่าน Web Browser บนอุปกรณ์พกพาได้ทั้งแบบชิ้นและแบบน้ำหนัก
...
2. หน้าจอต้องปรับตามขนาดอุปกรณ์โดยไม่สูญเสียฟังก์ชันสำคัญของงานนั้น
3. Withdrawal Web ต้องรองรับการเปิดกล้องของอุปกรณ์เพื่อสแกน Barcode/QR Code เมื่อ Browser และอุปกรณ์อนุญาต
4. งานรับเข้าและพิมพ์ Label ต้องรองรับการใช้งานบนคอมพิวเตอร์คลัง
5. Web Application ต้องส่งคำสั่งพิมพ์ไปยัง Print Control พร้อม Template, Lot, จำนวน, น้ำหนัก และข้อมูลฉลาก
6. Print Control ต้องรายงานสถานะอย่างน้อย ได้แก่ รอพิมพ์ กำลังพิมพ์ สำเร็จ และไม่สำเร็จ
7. การสั่งพิมพ์ซ้ำต้องระบุเหตุผลและถูกบันทึกใน Audit Log
8. หาก Print Control ไม่พร้อมใช้งาน ระบบต้องแจ้งผู้ใช้งานอย่างชัดเจนและไม่เปลี่ยนสถานะเป็นพิมพ์สำเร็จ
...
- หน้าจอต้องเป็น Responsive และรองรับคอมพิวเตอร์ โน้ตบุ๊ก แท็บเล็ต และโทรศัพท์มือถือ
- หน้าจอ Withdrawal Web บนอุปกรณ์พกพาต้องรองรับการใช้งานด้วยมือเดียวและปุ่มที่กดได้สะดวก
...
1. ผู้ใช้งานสามารถเข้า Management Web และ Withdrawal Web ผ่าน Web Browser ตามอุปกรณ์ที่กำหนดได้
...
9. สามารถตรวจนับแบบชิ้นและแบบน้ำหนักผ่าน Web Browser บนอุปกรณ์พกพา พร้อมปรับยอดตามสิทธิ์ได้
10. สามารถเบิกสินค้าผ่าน Withdrawal Web โดยสแกน Barcode/QR Code และตรวจสอบสิทธิ์ก่อนตัดสต็อกได้
...
- รุ่นเครื่องชั่ง เครื่องพิมพ์สติกเกอร์ เครื่องสแกน Barcode/QR Code และอุปกรณ์พกพาที่จะใช้งาน
...
- ใช้ Web Browser บนอุปกรณ์พกพาสำหรับตรวจนับและเบิกสินค้า
